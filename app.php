        ...
        <div id="bg_top">
            <div id="menu">
                <ul>
                    ...
                    <li><a href="blog.php">El B. I. T.</a></li>
                    <li><a href="gallery.php">Registre</a></li>
              ...
              <br /><br />
                <div id="content" class="column3">
                        <div class="col1">
                            ...
                            <div class="read"><a href="#">Més info</a></div>
                        </div>
                        <div class="col2">
                            <h3>Codi ASCII</h3>
                    ...
                    <div id="footer">
                        ...
                        <div class="footer_bg">
                            ...
                            <div class="footer_img">
                                <a href="www.uoc.edu"><img src="images/uoc.png" alt="" title=""/></a>
                            </div>
                            <div style="clear: both"></div>
                        </div>
