...
if(isset($_SESSION['username'])){
	...
	$sql = "SELECT * FROM USERS ORDER BY XP DESC, EXERCICESDONE DESC, EXERCICESFAIL ASC, LEVEL DESC";

	$result = mysqli_query($link, $sql);
	echo "<br /><br /><h1 align='center'>Rànquing d'alumnes</h1><br/><br/><table border='0' align='center' width='100%'><tr><th>&nbsp;</th><th>Username</th><th>Punts d'Experiència</th><th>Nivell</th></tr>";
	$i = 1;
	while ($row = mysqli_fetch_array($result)) {
		echo "<tr align='center'><td>".$i."</td><td>".$row["USERNAME"]."</td><td>".$row["XP"]."</td><td>".$row["LEVEL"]."</td></tr>";
		$i = $i + 1;
	}
	echo "</table>";
	mysqli_close($link);
